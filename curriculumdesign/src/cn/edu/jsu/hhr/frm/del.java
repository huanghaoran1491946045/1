...
public class del {
	...
	JButton btnNewButton = new JButton("\u5220\u9664\u8BE5\u7403\u5458");
	btnNewButton.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent e) {
			String a2=textField_2.getText().trim();
			String sql1="delete from Tableplayer where height="+a2;
			...
			try(Connection conn=dbcs.getConnection();//获取数据库连接
		    		...
		    		JOptionPane.showMessageDialog(null, "球员删除成功");
		    		...
		    		JOptionPane.showMessageDialog(null, "球员删除失败");
		    		e3.printStackTrace();
		    	}
		}
	});
	btnNewButton.setFont(new Font("宋体", Font.BOLD, 20));
	btnNewButton.setBounds(497, 438, 160, 55);
